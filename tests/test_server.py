...
class ServerTests(unittest.TestCase):
    ...
    def test_terrain_endpoint_is_available(self):
        status, payload = request_json(self.connection, "GET", "/terrain/land.geojson")
        self.assertEqual(status, 200)
    ...
    def test_scenario_crud_and_session_creation_from_saved_scenario(self):
        ...
        self.assertEqual(loaded["seed"]["side_metadata"]["Red"]["faction"], "Iran")
